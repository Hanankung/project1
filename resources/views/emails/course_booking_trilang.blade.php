...
<body style="background:#f9fafb;padding:20px">
  <div class="wrap"><div class="box">
    <h2>ยืนยันคำจองคอร์ส <span class="muted">/ EN & MY included below</span></h2>
    ...
    <div style="margin:16px 0 8px">
      <a href="{{ $detailUrl }}" class="btn">เปิดดูรายการจอง / View booking / Lihat tempahan</a>
    </div>
    ...
    <p>เราได้รับคำจองคอร์สของคุณเรียบร้อยแล้ว ตามรายละเอียดข้างต้น</p>
    <p>หากต้องการแก้ไขหรือยกเลิก สามารถกดปุ่ม “เปิดดูรายการจอง” ได้ทันที</p>

    <div class="hr"></div>

    {{-- ===== English ===== --}}
    <div class="tag">English</div>
    <p>Your course booking has been received. Please see the summary above.</p>
    <p>To modify or cancel, click “View booking”.</p>

    <div class="hr"></div>

    {{-- ===== Bahasa Melayu ===== --}}
    <div class="tag">Bahasa Melayu</div>
    <p>Tempahan kursus anda telah diterima. Sila rujuk ringkasan di atas.</p>
    <p>Untuk ubah atau batal, klik “Lihat tempahan”.</p>
