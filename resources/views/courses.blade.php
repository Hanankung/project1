            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('guest.courses.show', $course->id) }}" class="btn btn-outline-primary mt-auto">{{ __('messages.learn_more') }}</a>
                        <a href="{{ route('login') }}" class="btn btn-primary btn-sm mt-2 w-100">+ {{ __('messages.book_course') }}</a>
