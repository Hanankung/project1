...
@section('content')
    <form action="{{ route('admin.update', $post->id) }}" method="POST" enctype="multipart/form-data" id="productForm">
        @csrf
        @method('PUT')
        ...
        <div class="page-hero d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div class="d-flex align-items-center gap-3">
                <h1 class="m-0" style="font-weight:800; letter-spacing:.2px; color:var(--ink)">แก้ไขสินค้า</h1>
                <span class="badge text-bg-light">แก้ไขข้อมูลให้ครบใน 3 ส่วน: รายละเอียด 3 ภาษา | คลัง/ราคา | รูปภาพ</span>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('product_name') is-invalid @enderror"
                                name="product_name" value="{{ old('product_name', $post->product_name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control countable" name="description" rows="4" data-max="600"
                                placeholder="รายละเอียดสินค้า">{{ old('description', $post->description) }}</textarea>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="material"
                                    value="{{ old('material', $post->material) }}" placeholder="เช่น ผ้าฝ้ายธรรมชาติ">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">ขนาด</label>
                                <input type="text" class="form-control" name="size"
                                    value="{{ old('size', $post->size) }}" placeholder="เช่น 15 × 20 cm">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="product_name_ENG"
                                value="{{ old('product_name_ENG', $post->product_name_ENG) }}"
                                placeholder="Product name in English">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Description (English)</label>
                            <textarea class="form-control countable" name="description_ENG" rows="4" data-max="600">{{ old('description_ENG', $post->description_ENG) }}</textarea>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="material_ENG"
                                    value="{{ old('material_ENG', $post->material_ENG) }}">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="product_name_MS"
                                value="{{ old('product_name_MS', $post->product_name_MS) }}"
                                placeholder="Product name in Malay">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Description (Malay)</label>
                            <textarea class="form-control countable" name="description_MS" rows="4" data-max="600">{{ old('description_MS', $post->description_MS) }}</textarea>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="material_MS"
                                    value="{{ old('material_MS', $post->material_MS) }}">
                            </div>
                            <div class="col-md-6">
            ...
            <div class="col-12 col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0"
                                    ...
                                    value="{{ old('price', $post->price) }}" placeholder="0.00" required>
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <input type="number" min="0"
                                    ...
                                    value="{{ old('quantity', $post->quantity) }}" placeholder="0" required>
                                @error('quantity')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" type="checkbox" value="1" id="autoCrop"
                                        checked>
                        ...
                        {{-- ถ้าอยากมี “ลบรูปเดิม” ใส่ตัวเลือกนี้ (controller ต้องรองรับ) --}}
                        {{-- <div class="form-check mt-3">
            <input class="form-check-input" type="checkbox" name="remove_image" value="1" id="removeImage">
            <label class="form-check-label" for="removeImage">ลบรูปเดิม</label>
          </div> --}}
                    </div>
                </div>
            </div>
        ...
        <div class="sticky-actions">
            <div class="d-flex gap-2 justify-content-end">
                ...
                <button type="submit" class="btn btn-brand">
                    <i class="bi bi-save2"></i> อัปเดตสินค้า
                </button>
            </div>
        </div>
    </form>
