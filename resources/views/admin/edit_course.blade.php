{{-- resources/views/admin/course_edit.blade.php --}}
@extends('admin.layout')

@section('content')
    <form action="{{ route('admin.update_course', $post->id) }}" method="POST" enctype="multipart/form-data" id="courseForm">
        @csrf
        @method('PUT')
        ...
        <div class="page-hero d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div class="d-flex align-items-center gap-3">
                <h1 class="m-0" style="font-weight:800; letter-spacing:.2px; color:var(--ink)">แก้ไขคอร์สเรียน</h1>
                <span class="badge text-bg-light">แก้ไข: รายละเอียด 3 ภาษา | ราคา | รูปภาพ</span>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('course_name') is-invalid @enderror"
                                id="course_name" name="course_name" value="{{ old('course_name', $post->course_name) }}"
                                required>
                            @error('course_name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control countable" id="course_detail" name="course_detail" rows="4" data-max="800"
                                placeholder="สิ่งที่จะได้เรียนรู้ / อุปกรณ์ / เงื่อนไข ฯลฯ">{{ old('course_detail', $post->course_detail) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="course_name_ENG" name="course_name_ENG"
                                value="{{ old('course_name_ENG', $post->course_name_ENG) }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Course details (English)</label>
                            <textarea class="form-control countable" id="course_detail_ENG" name="course_detail_ENG" rows="4" data-max="800">{{ old('course_detail_ENG', $post->course_detail_ENG) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="course_name_MS" name="course_name_MS"
                                value="{{ old('course_name_MS', $post->course_name_MS) }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Course details (Malay)</label>
                            <textarea class="form-control countable" id="course_detail_MS" name="course_detail_MS" rows="4" data-max="800">{{ old('course_detail_MS', $post->course_detail_MS) }}</textarea>
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="file" class="form-control mt-2" id="course_image" name="course_image"
                                accept="image/*">
        ...
        <div class="sticky-actions">
            <div class="d-flex gap-2 justify-content-end">
                ...
                <button type="submit" class="btn btn-brand">
                    <i class="bi bi-save2"></i> อัปเดตคอร์ส
                </button>
            </div>
        </div>
    </form>
